...
const data = {
  ...
  tasks: [
    ...
    { id: '2', name: 'Requirements Analysis', startTime: '2027-02-02', endTime: '2027-02-06', type: 'task', progress: 100, parent: '1',
      resources: [{ id: 'tr1', resourceId: 'r3', capacity: 100 }] },
    { id: '3', name: 'Architecture Design', startTime: '2027-02-09', endTime: '2027-02-13', type: 'task', progress: 80, parent: '1',
    ...
    { id: '5', name: 'Frontend Development', startTime: '2027-02-16', endTime: '2027-03-06', type: 'task', progress: 40, parent: '4',
      resources: [{ id: 'tr4', resourceId: 'r2', capacity: 100 }] },
    { id: '6', name: 'Backend API', startTime: '2027-02-16', endTime: '2027-03-13', type: 'task', parent: '4',
      resources: [{ id: 'tr5', resourceId: 'r1', capacity: 100 }] },
    { id: '7', name: 'Database Schema', startTime: '2027-02-16', endTime: '2027-02-27', type: 'task', parent: '4',
    ...
    { id: '9', name: 'Unit Testing', startTime: '2027-03-16', endTime: '2027-03-20', type: 'task', parent: '8',
      resources: [{ id: 'tr8', resourceId: 'r4', capacity: 100 }, { id: 'tr9', resourceId: 'r1', capacity: 50 }] },
    { id: '10', name: 'Integration Testing', startTime: '2027-03-23', endTime: '2027-03-27', type: 'task', parent: '8',
