...
import { ResourceHistogram, ResourceHistogramRef } from '@timelinekit/react';
import { setLicense, HistogramResource, HistogramAllocation, DateRange } from '@timelinekit/core';
