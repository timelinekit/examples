...
const data = {
  tasks: [
    ...
    { id: '2', name: 'Market Research', startTime: '2027-01-05', endTime: '2027-01-09', type: 'task', progress: 100, parent: '1' },
    { id: '3', name: 'Requirements Analysis', startTime: '2027-01-12', endTime: '2027-01-16', type: 'task', progress: 100, parent: '1' },
    { id: '4', name: 'Technical Spike', startTime: '2027-01-12', endTime: '2027-01-14', type: 'task', progress: 100, parent: '1' },
    { id: '5', name: 'Plan Sign-off', startTime: '2027-01-23', type: 'milestone', parent: '1' },

    { id: '6', name: 'Design', startTime: '2027-01-26', endTime: '2027-02-13', type: 'summary', subtasks: ['7', '8', '9', '10'] },
    { id: '7', name: 'Wireframes & Prototyping', startTime: '2027-01-26', endTime: '2027-01-30', type: 'task', progress: 80, parent: '6' },
    { id: '8', name: 'Visual Design', startTime: '2027-02-02', endTime: '2027-02-06', type: 'task', progress: 60, parent: '6' },
    { id: '9', name: 'Design System Setup', startTime: '2027-02-02', endTime: '2027-02-10', type: 'task', progress: 40, parent: '6' },
    { id: '10', name: 'Design Review', startTime: '2027-02-13', type: 'milestone', parent: '6' },

    { id: '11', name: 'Development', startTime: '2027-02-16', endTime: '2027-04-03', type: 'summary', subtasks: ['12', '13', '14', '15', '16', '17'] },
    { id: '12', name: 'Frontend Implementation', startTime: '2027-02-16', endTime: '2027-03-13', type: 'task', progress: 25, parent: '11' },
    { id: '13', name: 'Backend API', startTime: '2027-02-16', endTime: '2027-03-20', type: 'task', progress: 15, parent: '11' },
    { id: '14', name: 'Database & Migrations', startTime: '2027-02-16', endTime: '2027-02-27', type: 'task', parent: '11' },
    { id: '15', name: 'Auth & Security', startTime: '2027-03-02', endTime: '2027-03-13', type: 'task', parent: '11' },
    { id: '16', name: 'API Integration', startTime: '2027-03-16', endTime: '2027-03-27', type: 'task', parent: '11' },
    { id: '17', name: 'Dev Complete', startTime: '2027-04-03', type: 'milestone', parent: '11' },

    { id: '18', name: 'Testing & Launch', startTime: '2027-04-06', endTime: '2027-04-24', type: 'summary', subtasks: ['19', '20', '21', '22'] },
    { id: '19', name: 'Unit & Integration Tests', startTime: '2027-04-06', endTime: '2027-04-10', type: 'task', parent: '18' },
    { id: '20', name: 'E2E Testing', startTime: '2027-04-13', endTime: '2027-04-17', type: 'task', parent: '18' },
    { id: '21', name: 'Staging Deployment', startTime: '2027-04-20', endTime: '2027-04-22', type: 'task', parent: '18' },
    { id: '22', name: 'Production Launch', startTime: '2027-04-24', type: 'milestone', parent: '18' },
  ],
  links: [
